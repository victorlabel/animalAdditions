summon llama ~ ~ ~ {Tame:1b,Age:-999999999,Tags:["mini","New"]}
...
kill @e[type=item,nbt={Item:{id:"minecraft:white_wool",Count:2b}}]
kill @e[type=item,nbt={Item:{id:"minecraft:apple",Count:1b}}]